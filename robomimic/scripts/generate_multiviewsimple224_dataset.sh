...
python camera_config/generate_camera_config.py \
    ...
    --filename multiview_simple224.json \
...
python dataset_states_to_obs.py  \
    ...
    --additional_camera_config=/root/dataset/robomimic/dataset/lift/ph/multiview_simple224.json \
    --texture_config=texture_config/simple_arena.json \
    --output_name multiview_simple224.hdf5 \
    --camera_names agentview birdview sideview frontview \
    --camera_height 224 \
	--camera_width 224
    python playback_dataset.py --use-obs \
    --dataset /root/dataset/robomimic/dataset/lift/ph/multiview_simple224.hdf5 \
    --video_path /root/dataset/robomimic/dataset/lift/ph/multiview_simple224.mp4 \
...
python dataset_states_to_obs.py  \
    ...
    --additional_camera_config=/root/dataset/robomimic/dataset/can/ph/multiview_simple224.json \
    --texture_config=texture_config/simple_arena.json \
    --output_name multiview_simple224.hdf5 \
    ...
    --camera_width 224
python playback_dataset.py --use-obs \
    --dataset /root/dataset/robomimic/dataset/can/ph/multiview_simple224.hdf5 \
    --video_path /root/dataset/robomimic/dataset/can/ph/multiview_simple224.mp4 \
    --render_image_names view0 view1 view2 view3 view4 \
    --n 1
fi
